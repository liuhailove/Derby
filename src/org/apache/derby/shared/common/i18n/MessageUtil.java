...
public class MessageUtil
{
     ...
     */
	public static String getCompleteMessage(Locale locale,String resourceBundleName,
			String messageId,Object[]arguments,boolean composeDefault)  throws MissingResourceException
	{
		try
		{
			return formatMessage(ResourceBundle.getBundle(resourceBundleName, locale),messageId,
					arguments,false);
		}
			...
			try
			{
				...
				if(SanityManager.DEBUG)
				{
					...
					SanityManager.ASSERT(numExpected==arguments.length,
							"Number of parameters expected for message id"+messageId+
							" ("+numExpected+") does not match number of arguments for message id "+
							arguments.length+")");
				}
				try
				{
