...
public class JiraConnector
{
	...
	public static String jira_allBugsSource= "https://issues.apache.org/jira/secure/IssueNavigator.jspa?" +
			"view=rss&pid=10594&sorter/field=issuekey&sorter/order=DESC&tempMax=6000&reset=true&decorator=none";
	...
	private static void getXMLStreamAndFile(String fileName, String stream) throws IOException 
	{
		...
		try
		{
			BufferedReader in=new BufferedReader(new InputStreamReader(getXMLStream(XMLurl)));
			String inputLine;
